...
export default function ProductsExportPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Xuất Thành Phẩm</h1>
        <p className="text-muted-foreground mt-2">Ghi nhận giao dịch xuất kho thành phẩm</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Phiếu Xuất Thành Phẩm</CardTitle>
          <CardDescription>Điền thông tin chi tiết về thành phẩm xuất kho</CardDescription>
        </CardHeader>
        <CardContent>
