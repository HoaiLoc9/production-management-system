...
export default function AddProductionPlanPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Thêm Kế Hoạch Sản Xuất</h1>
        <p className="text-muted-foreground mt-2">Tạo một kế hoạch sản xuất mới</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Thông Tin Kế Hoạch</CardTitle>
          <CardDescription>Điền thông tin chi tiết về kế hoạch sản xuất</CardDescription>
        </CardHeader>
        <CardContent>
